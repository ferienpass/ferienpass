...
#[AsPage('lost_password_confirm', contentComposition: false)]
class LostPasswordConfirmPage extends AbstractController
{
    public function __invoke(Request $request): Response
    {
        ...
        return $this->createPageBuilder($request->attributes->get('pageModel'))
            ->addFragment('main', new FragmentReference('ferienpass.fragment.lost_password_confirm'))
            ->getResponse()
        ;
    }
}
