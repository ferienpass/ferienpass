...
{
    public function __construct(private readonly OfferEntityInterface $offer, private readonly Participant $participant, private readonly TranslatableMessage $userMessage)
    {
