...
class AttendanceFacade
{
     ...
     */
    public function preview(OfferEntityInterface $offer, Participant $participant): Attendance
    {
     ...
     */
    public function create(OfferEntityInterface $offer, Participant $participant, string $status = null, bool $notify = true): void
    {
    ...
    private function findOrCreateAttendance(OfferEntityInterface $offer, Participant $participant, ?string $status): ?Attendance
    {
