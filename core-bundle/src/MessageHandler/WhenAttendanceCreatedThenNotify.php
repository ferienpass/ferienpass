...
{
    public function __construct(private ICalExport $iCal, private TranslatorInterface $translator, private AttendanceRepository $attendanceRepository, private UrlGeneratorInterface $router)
    {
    }
