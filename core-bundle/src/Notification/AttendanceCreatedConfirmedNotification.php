...
class AttendanceCreatedConfirmedNotification extends Notification implements NotificationInterface, EmailNotificationInterface
{
    ...
    {
        return 'attendance_created_confirmed';
    }
